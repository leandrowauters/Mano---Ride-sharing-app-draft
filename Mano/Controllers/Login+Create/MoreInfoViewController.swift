...
class MoreInfoViewController: UIViewController {
    ...
    func updateMoreInfo() {
        ...
        let updatedManoUser = ManoUser(firstName: self.manoUser.firstName, lastName: self.manoUser.lastName, fullName: self.manoUser.fullName, homeAdress: homeAddress, homeLat: self.homeLat, homeLon: self.homeLon, profileImage: nil, carMakerModel: nil, bio: nil, typeOfUser: self.manoUser.typeOfUser, regulars : nil, joinedDate: self.manoUser.joinedDate, userId: self.manoUser.userId, numberOfRides: nil, numberOfMiles:  nil, licencePlate: nil, carPicture: nil,cellPhone: cellPhone, rides: nil)
